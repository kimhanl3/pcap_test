...
# Project:  ../test9/pcap_test.pro
# Template: app
# Command: /home/sky/Qt/5.13.0/gcc_64/bin/qmake -o Makefile ../test9/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../test9 -I. -I../Qt/5.13.0/gcc_64/mkspecs/linux-g++
QMAKE         = /home/sky/Qt/5.13.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/sky/Qt/5.13.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/sky/Qt/5.13.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
DISTDIR = /home/sky/build-pcap_test-Desktop_Qt_5_13_0_GCC_64bit-Debug/.tmp/pcap_test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
DIST          = ../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../test9/pcap_test.pro  ../test9/main.cpp
...
Makefile: ../test9/pcap_test.pro ../Qt/5.13.0/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.13.0/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/sanitize.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../Qt/5.13.0/gcc_64/mkspecs/features/lex.prf \
		../test9/pcap_test.pro
	$(QMAKE) -o Makefile ../test9/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
main.o: ../test9/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../test9/main.cpp
